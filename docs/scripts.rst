...
The easiest way to make your scripts compatible with Scriptly is to define
...
This will add a script or a folder of scripts to Scriptly (if a folder is
passed instead of a file). By default, scripts will be created in the
'Scriptly Scripts' group.

Script Organization
-------------------

Scripts can be viewed at the root url of Scriptly. The ordering of scripts,
