.. figure:: ../scriptly-banner.png
   :alt: Scriptly!

Welcome to Scriptly's documentation
================================

Scriptly is a simple web interface to run command line Python scripts. Think of it as an easy way to get your scripts
...
Mitchell <https://github.com/Chris7>`__ and Flask-based Scriptly by `Martin
