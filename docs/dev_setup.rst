...
The `docker` folder contains the Docker setup. Scriptly can be built and run by simply
running
...
* run -- run a command in the scriptly container. For example, a bash shell can be started by `run bash`
