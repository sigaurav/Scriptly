...
Configuring Amazon S3 Storage for Scriptly
=======================================
...
* Edit your CORS configuration for the bucket:
  ::
    ...
    <CORSConfiguration xmlns="http://s3.amazonaws.com/doc/2006-03-01/">
        ...
        <CORSRule>
            <AllowedOrigin>scriptly.fly.dev</AllowedOrigin>
            <AllowedMethod>GET</AllowedMethod>
...
* If using a bootstrapped Scriptly, update user_settings.py and uncomment out the following section: (or add it for apps Scriptly was added to)
  ...
  ::
        ...
        ALLOWED_HOSTS = (
            'localhost',
            '127.0.0.1',
            "scriptly.fly.dev",  # put your site here
        )
...
In the above step, make sure you change scriptly.fly.dev to your app's address.
...
If you are using Heroku, you can set them as follows::
    ...
    heroku config:set -a scriptly AWS_ACCESS_KEY_ID=access_key
    heroku config:set -a scriptly AWS_SECRET_ACCESS_KEY=secret_key
    heroku config:set -a scriptly AWS_STORAGE_BUCKET_NAME=bucket_name
