        ...
        jobs.append(
            {
                ...
                "url": reverse("scriptly:scriptly_job_detail", kwargs={"job_id": job.pk}),
                ...
                response.update(
                    {
                        ...
                        "extra": {
                            "job_url": reverse(
                                "scriptly:scriptly_job_detail", kwargs={"job_id": new_job.pk}
                            )
                        },
                    }
                )
                ...
                response.update(
                    {
                        "valid": True,
                        "redirect": reverse(
                            "scriptly:scriptly_job_detail", kwargs={"job_id": job_id}
                        ),
                    }
                )
            elif command == "delete":
