...
# ✅ Custom ScriptGroup admin to only show real model fields
class ScriptGroupAdmin(admin.ModelAdmin):
    list_display = ('group_name', 'description')  # optional
    fields = ['group_name', 'description']

# ✅ Unregister safely
from django.contrib.admin.sites import AlreadyRegistered
try:
    admin.site.unregister(ScriptGroup)
except admin.sites.NotRegistered:
    pass

admin.site.register(ScriptGroup, ScriptGroupAdmin)
...
class ScriptAdmin(ModelAdmin):
    ...
    class Media:
        js = (os.path.join("scriptly", "js", "admin", "script.js"),)
...
class VirtualEnvironmentAdmin(ModelAdmin):
    def get_changeform_initial_data(self, request):
        return {
            ...
            "venv_directory": scriptly_settings.SCRIPTLY_VIRTUAL_ENVIRONMENT_DIRECTORY,
        }


# Remaining admin registrations
site.register(ScriptlyWidget)
site.register(ScriptlyJob, JobAdmin)
