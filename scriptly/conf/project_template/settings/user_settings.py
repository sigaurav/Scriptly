import errno
import os
from .scriptly_settings import *  # noqa: F401, F403

# This file is where the user can override and customize their installation of scriptly

# Scriptly Apps - add additional apps here after the initial install (remember to follow everything by a comma)

INSTALLED_APPS += ()  # noqa: F405

# Whether to allow anonymous job submissions, set False to disallow 'guest' job submissions
SCRIPTLY_ALLOW_ANONYMOUS = True
...
SCRIPTLY_REALTIME_CACHE = "default"
CACHES = {
    "default": {
        "BACKEND": "django.core.cache.backends.db.DatabaseCache",
        "LOCATION": "scriptly_cache_table",
    }
}
...
#     'localhost',
#     '127.0.0.1',
#     "scriptly.herokuapp.com",# put your site here
# )
#
...
#
# STATICFILES_STORAGE = DEFAULT_FILE_STORAGE = 'scriptly.scriptlystorage.CachedS3BotoStorage'
# SCRIPTLY_EPHEMERAL_FILES = True
